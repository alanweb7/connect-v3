...
export class HistoricoService {
  ...
  create(hist: Historico): Promise<Historico> {
    ...
    return <Promise<Historico>>this.db.executeSql('INSERT INTO historico (id_serv,code,titulo,img,card) VALUES (?,?,?,?,?)', [hist.id_serv,hist.code,hist.titulo,hist.img,hist.card])
      .then(resultSet => {
