...
uploadVideo(){
 // this.navCtrl.push('VideCodeFirebasePage',{videos:this.videos,token:this.token,code:this.id_code,package_videos:this.package_videos,package_name:this.package_name});
