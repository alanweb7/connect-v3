...
export class AudioListPage {
  ...
  uploadVideo() {
    this.navCtrl.push('VideCodeFirebasePage', {
      font_capture: this.fontCapture, videos: this.videos, token: this.token, code: this.id_code, package_videos: this.package_videos, package_name: this.package_name, lang: this.lang,
